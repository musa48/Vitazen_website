		...
		global $posterity_a13; ?>
			<div class="foot-items">
				<div class="foot-content clearfix">
					...
					?>
					<div class="credtext">
                    	<?php esc_html_e('By ','posterity');?><a class="credlink" href="<?php echo esc_url('https://www.sktthemes.org/');?>" rel="nofollow" target="_blank"><?php esc_html_e('SKT Themes','posterity'); ?></a>
                    </div>
					<?php
